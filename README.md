...
- Solution URL: (https://github.com/shalri/fm-todo-app/)
- Live Site URL: (https://shalri.github.io/fm-todo-app/)
...
I heavily used `localStorage` on this challenge. The user's theme preference and
the Todo's are stored in `localStorage`. I leaned on Framer-motion for the drag
